...
```javascript
quaternary = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-quaternary@v0.2.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/strided-base-quaternary/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/strided-base-quaternary/actions/workflows/test.yml?query=branch:v0.2.2
